...
public class VNPayServiceImpl implements VNPayService {
    ...
    @Override
    public String createPaymentUrl(long amount, String email, long userId, long planId, String ipAddr, long durationMonths) {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_OrderInfo = "GoiDichVu" + "-" + planId + "-" + email + "-" + durationMonths;
